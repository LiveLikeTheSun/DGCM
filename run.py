...
parser.add_argument('--emb_size', type=int, default=160, help='pretrain embedding size')
parser.add_argument('--no-cuda', action='store_true', default=False,
                    help='Disables CUDA training.')
parser.add_argument('--num_fix_node', type=int, default=31, help='the number of fixed graph nodes(exclude multimodal nodes)')
parser.add_argument('--num_start_idx_sni', type=int, default=21, help='the start number index of snippet nodes')
...
parser.add_argument('--lr_decay', type=float, default=0.5,
                                help='lr decay')
parser.add_argument('--eval_freq', type=int, default=2,#300,
...
def train(args, data, test_data):
    ...
    for epoch in range(args.epochs):
        model.train(epoch, data, test_data)
